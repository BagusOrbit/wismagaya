...
<html>
  <head>
    <meta charset="UTF-8">
    <title>{{ $page_title or "WisamaGAYA System" }}</title>
    ...
    {{--<link href="{{ asset('/css/bootstrap-chosen.min.css') }}" rel="stylesheet" type="text/css" />--}}
...
<script src="{{ asset('/js/bootstrap-datepicker.id.js') }}" type="text/javascript"></script>
{{--<script src="{{ asset('/js/chosen.jquery.min.js') }}" type="text/javascript"></script>--}}
<script src="{{ asset('/js/sisdm.js') }}" type="text/javascript"></script>
 @yield('scripts')
